...
class TechnicalTest {
  ...
  List list = [
    ...
    () {
      ...
      output = {for (var word in words) word: word.length};
      // --- End of Answer ---
    ...
    () {
      ...
      Map<String, double>? output;
      List<String> pairs =
          input.split(","); // Memisahkan string berdasarkan koma
      output = {
        for (var pair in pairs)
    ...
    () {
      ...
      List<String> pairs = input.split(",");
      output = {
        for (var pair in pairs) pair.split(":")[0]: pair.split(":")[1] == "true"
      };
    ...
    */
    ...
    () {
      String input = "Hello World!";
      // Mengambil kata pertama dari input
    ...
    () {
      String text = "Dart is awesome";
      // Mengubah variable text menjadi huruf kecil semua.
      String output = text.toLowerCase();
      return output == "dart is awesome";
    },
    ...
    () {
      String text = "  Dart is awesome  ";
      // Menghapus spasi di awal dan akhir dari variable text.
      String output = text.trim();
      return output == "Dart is awesome";
    },
